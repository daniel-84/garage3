sap.ui.define([
	...
	return Opa5.extend("garage.btp.garagebtp3.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["garage/btp/garagebtp3/localService/mockserver"], function (mockserver) {
