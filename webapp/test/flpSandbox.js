		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App garage btp",
									"targetURL": "#garagebtpgaragebtp3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"garagebtpgaragebtp3-display": {
								"semanticObject": "garagebtpgaragebtp3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=garage.btp.garagebtp3",
									"url": sap.ui.require.toUrl("garage/btp/garagebtp3")
								}
							}
						}
					}
